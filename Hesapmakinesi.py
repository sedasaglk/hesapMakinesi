...
lbl1 = Label(w, text="Hesap Makinesi", font=("Times New Roman", 35), fg="#232226", bg="#fc9d03")
...
btn_equals = Button(w, text="Hesapla", font=("Unispace", 24,), command=equals, bg="#e876e6")
btn_clear = Button(w, text="Temizle", font=("Unispace", 24,), command=cls, bg="#e876e6")
